package net.jack.lightning.staffmode.itembuilder;
...
public class ItemBuild {
    ...
    public ItemBuild addKey(NamespacedKey key, String value) {
        this.itemMeta.getPersistentDataContainer().set(key, PersistentDataType.STRING, value);
        return this;
    }
}
